...
Given('I am on the conduit login page', {timeout: 20 * 5000}, async function () {
...
When('I login with valid credentials', async function () {
    await page.locator('input[placeholder="Email"]').type("playwrightdemo@gmail.com");
    await page.locator('input[placeholder="Password"]').type("playwrightdemo");
